...
public interface IEmailService
{
    ...
    Task SendPointsEarnedEmailAsync(string toEmail, string firstName, decimal pointsEarned, decimal newBalance, string? userId = null, bool isPortalUser = false);
    Task SendPointsRedeemedEmailAsync(string toEmail, string firstName, decimal pointsRedeemed, decimal kesAmount, string redemptionReference, decimal newBalance, string? userId = null, bool isPortalUser = false);
    ...
    Task SendExplorerInterestOriginalAgentFyiEmailAsync(string toEmail, string firstName, string houseNumber, string flatName, string currentAgentName, string? userId = null, bool isPortalUser = false);
}
